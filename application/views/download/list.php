<section class="bg-servicesstyle2-section mt-5">
  <div class="container">
    <div class="row mt-5">
           ...
           <tbody>
            <?php $i=1; foreach($download as $download) { ?>
             <tr>
               ...
               <td>
                 <a href="<?php echo base_url('download/unduh/'.$download->id_download) ?>" class="genric-btn primary circle" target="_blank">
                 Unduh</a>
               </td>
             </tr>
             <?php $i++; } ?>
