...
<div class="row">
    <div class="col-md-12">
        <div class="form-group">
            ...
            <input type="text" name="judul_download" class="form-control"
                value="<?php echo set_value('judul_download'); ?>" placeholder="Judul download..">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <select name="jenis_download" class="form-control">
                ...
                <option value="Panduan">Panduan/Pengumuman</option>
            </select>
        </div>
    </div>
    <div class="col-md-4">
    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            <input type="url" name="website" class="form-control" placeholder="http://website.com"
