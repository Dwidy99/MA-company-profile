...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="col-md-4">
            ...
            <img src="<?= base_url('assets/uploads/logo/thumbs/'.$configure->logo); ?>"
                alt="<?= $configure->namaweb; ?>" class="img img-thumbnail img-responsive mt-3">
            <?php else : ?>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="file" name="logo" class="form-control" onchange="tampilkanPreview(this,'preview')"
                        required>
                </div>
            </div>
            <div class="col-md-4">
