               ...
               <article class="blog_item">
                  <div class="blog_item_img">
                     <a href="<?= base_url('assets/uploads/galeri/'.$galeri->gambar); ?>" class="img-lightbox">
                        <img class="card-img rounded-0" src="<?= base_url('assets/uploads/galeri/'.$galeri->gambar); ?>"
                  ...
                  <ul class="list cat-list">
                     ...
                     <li>
                        <a href="<?= base_url('berita/kategori/'.$kNew->slug_kategori); ?>" class="d-flex">
                           ...
                           <p>(<?= count($this->Berita_model->total_kategori_berita($kNew->id_kategori_berita)); ?>)</p>
                        </a>
                     </li>
                     <?php endforeach; ?>
                  </ul>
