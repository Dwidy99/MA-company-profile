                        ...
                        <div class="row d-flex justify-content-between align-items-center">
                            ...
                            <div class="header-info-right">
                                <ul class="header-social">
                                    ...
                                    <li><a href="<?= $site_info->instagram; ?>"><i class="fab fa-instagram"></i></a>
                                    </li>
                                    <li> <a href="<?= $site_info->website; ?>"><i class="fas fa-laptop-code"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-3">
                            <div class="logo">
                                <a href="<?= base_url(); ?>">
                                    <img src="<?= base_url('assets/uploads/logo/thumbs/'.$site_info->logo); ?>"
