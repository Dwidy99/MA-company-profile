    <div class="trending-area fix mt-5">
        <div class="container">
            <div class="trending-main">
                <div class="row">
                    <div class="col-md">
                        <div id="myCaraousel" class="carousel slide" data-ride="carousel">
                            <ol class="carousel-indicators">
                                <li data-target="#myCaraousel" data-slide-to="0" class="active"></li>
                                <li data-target="#myCaraousel" data-slide-to="1"></li>
                                <li data-target="#myCaraousel" data-slide-to="2"></li>
                            </ol>
                            <div class="carousel-inner">
                                <?php $i=1; foreach($sliders as $slider) :?>
                                <div class="carousel-item <?php if($i==1) {echo 'active';} ?>">
                                    <img src="<?= base_url('assets/uploads/galeri/'.$slider->gambar) ?>"
                                    class="d-block w-100" alt="<?= $slider->judul_galeri; ?>">
                                    <div class="carousel-caption text-left">
                                        <h1 class="text-white"><?= $slider->judul_galeri; ?></h1>
                                        <p class="text-white">
                                            <?= strip_tags(character_limiter($slider->isi_galeri, 50)); ?>
                                        </p>
                                    </div>
                                </div>
                                <?php $i++; endforeach; ?>
                        ...
                        <div class="weekly-news-active dot-style d-flex dot-style">
                            ...
                            <div class="weekly-single <?php if($i==1){ echo 'active';} ?>">
                                ...
                                <div class="weekly-caption">
                                    <h6><a
                                        href="<?= base_url('layanan/read/'.$service->slug_layanan); ?>"><?= $service->judul_layanan; ?></a>
                                    </h6>
                                </div>
                            </div>
                            <?php $i++; endforeach; ?>
                                        ...
                                        <div class="col-lg-4 col-md-4">
                                            <div class="single-what-news mb-100">
                                                ...
                                                <div class="what-cap">
                                                    ...
                                                    <h4><a
                                                        href="<?= base_url('berita/read/'.$lastesNew->slug_berita); ?>"><?= $lastesNew->judul_berita; ?></a>
                                                    </h4>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-4 col-md-4">
                                        <div class="single-what-news mb-100">
                                            ...
                                            <div class="what-cap">
                                                ...
                                                <h4>
                                                    <a
                                                    href="#"><?= strip_tags(character_limiter($gallery->isi_galeri, 20)); ?></a>
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
