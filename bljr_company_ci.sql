...
CREATE TABLE `galeri` (
  ...
  KEY `id_user` (`id_user`),
  CONSTRAINT `galeri_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `users` (`id_user`)
...
INSERT INTO `galeri` VALUES (3,1,'Laptop Ringan','<p>Laptop teringan dengan harga termurah</p>','https://www.youtube.com',0,'11.jpg','homepage','2021-12-15 03:46:00','2021-12-15 09:46:00'),(4,1,'Sport Car','<p>Jakarta - Ada hal berbeda saat Presiden Joko Widodo (Jokowi) memberikan sambutan dalam acara pembukaan Kongres Ekonomi Umat Islam II MUI. Jokowi sengaja tak membaca bahan sambutan yang sudah disiapkan untuk menjawab secara langsung kritikan dari Wakil Ketua Umum Majelis Ulama Indonesia (MUI), Anwar Abbas.<br />Dalam acara diketahui Anwar Abbas memberikan kata sambutan terlebih dulu dibandingkan Jokowi. Pada kesempatan itu, Anwar Abbas menyinggung soal kesenjangan ekonomi dan sosial yang dinilai semakin terjal.</p>','https://www.youtube.com',0,'3.jpg','galeri','2021-12-17 11:03:52','2021-12-17 11:03:52'),(5,1,'Laptop Keren','<p>Laptop terbaik dan termurah</p>','https://www.google.com',0,'2.jpg','homepage','2021-12-15 03:30:02','2021-12-15 09:30:02'),(6,1,'Laptop tipis tercanggih','<p>Laptop tiada tanding dengan teknologi tertipis</p>','https://www.google.com',0,'31.jpg','homepage','2021-12-15 03:44:28','2021-12-15 09:44:28'),(7,1,'Launching Windows Laptop','<p>Launching pertama di markas Real madrid Santiago Bernabeu</p>','',0,'windows-ACWCQs6KXcw-unsplash.jpg','galeri','2021-12-17 11:10:01','2021-12-17 11:10:01'),(8,1,'Rilis Film Spongeboob Series','<p>Spongeboob Film Terlaris sepanjang masa kini telah merilis Film terbarunya di Sinema XXIV</p>','',0,'spongebob-11.jpg','galeri','2021-12-17 11:11:00','2021-12-29 17:08:04');

#
# Structure for table "kategori_berita"
#
...
#
# Data for table "kategori_berita"
#

INSERT INTO `kategori_berita` VALUES (2,'Olahraga','olahraga',2,'2021-12-08 19:35:46'),(3,'Politik','politik',3,'2021-12-08 19:36:05'),(4,'Tauran warga','tauran-warga',4,'2021-12-08 19:47:16'),(9,'Finansial','finansial',1,'2021-12-11 15:03:47'),(10,'Tentang Perusahaan','tentang-perusahaan',5,'2021-12-11 16:22:45'),(11,'Nusantara','nusantara',6,'2021-12-12 03:11:28'),(12,'Nasional','nasional',7,'2021-12-12 03:15:28');
...
INSERT INTO `kontak` VALUES (4,'Dwi','diemaja@gmail.com','ngtienotejijwijeq','qwoiehjioqjiowejiqjegnrw','2021-12-18 11:52:54');

#
# Structure for table "kunjungan"
#
...
#
# Data for table "kunjungan"
#

INSERT INTO `kunjungan` VALUES (39,'http://192.168.100.139/jwmCompany/berita','192.168.100.138',5,'2021-12-17','2021-12-17 16:46:38','2021-12-17 16:46:38'),(40,'http://localhost/jwmCompany/berita/read/assets/img','::1',8,'2021-12-17','2021-12-17 20:59:10','2021-12-18 12:53:00'),(41,'http://localhost/company-profile/berita/read/asset','::1',31,'2021-12-18','2021-12-18 10:53:37','2021-12-18 13:31:53'),(42,'http://localhost/MA-company-profile/kontak','::1',155,'2021-12-26','2021-12-26 10:37:32','2021-12-26 12:21:09'),(43,'http://localhost/MA-company-profile/','::1',5,'2021-12-29','2021-12-29 16:33:32','2021-12-29 16:56:44');
...
INSERT INTO `users` VALUES (1,'Eden Hazard','rchemical7@gmail.com','Lizard','$2y$10$0Tiioj4qMn0tYCmgSYiePugKWAbfnCZ62YxMd7OLKAzKWhq9dAmD.','Admin','2021-12-14 10:46:07'),(6,'Kopit\'a Manzukic','98dwiyulianto@gmail.com','MieInstant','$2y$10$GIu0/DhIxG9fpIsk4QzfF.OpkhjnJt9QfD3WKeKcNrEru.dFfhNkG','User','2021-12-13 20:18:58');
...
CREATE TABLE `layanan` (
  ...
  KEY `id_user` (`id_user`),
  CONSTRAINT `layanan_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `users` (`id_user`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `konfigurasi` (
  ...
  KEY `id_user` (`id_user`),
  CONSTRAINT `konfigurasi_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `users` (`id_user`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4;

#
# Data for table "konfigurasi"
#

INSERT INTO `konfigurasi` VALUES (1,1,'The Best Company','The Best Company','jakatingkir@gmail.com','https://www.google.com','081313267345','Jl. Suka nyasar linglung 7x','The Best Company in The World','The Best Company in The World','The Best Company in The World','<iframe src=\"https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d31735.983036860845!2d106.49703160000003!3d-6.1309857!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sid!4v1639131310498!5m2!1sen!2sid\" width=\"1170\" height=\"450\" style=\"border:0;\" allowfullscreen=\"\" loading=\"lazy\"></iframe>','android-chrome-512x512.png','android-chrome-512x512.png','https://www.facebook.com','https://www.instagram.com','2021-12-16 03:09:25');
...
CREATE TABLE `berita` (
  ...
  KEY `id_user` (`id_user`),
  KEY `id_kategori` (`id_kategori_berita`),
  CONSTRAINT `berita_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `users` (`id_user`),
  CONSTRAINT `berita_ibfk_2` FOREIGN KEY (`id_kategori_berita`) REFERENCES `kategori_berita` (`id_kategori_berita`)
