...
(17, 1, 2, '', 'paris-saint-germains-sergio-ramos-wishes-club-had-avoided-ucl-draw-with-real-madrid', 'Paris Saint-Germain\'s Sergio Ramos wishes club had avoided UCL draw with Real Madrid', '<p><span xss=removed>PARIS – Sergio Ramos seakan berkhianat dari Real Madrid. Bek tengah asal Spanyol itu rela mati demi Paris Saint-Germain (PSG) saat melawan eks klubnya pada babak 16 besar Liga Champions 2021-2022.</span></p>\r\n<p><span xss=removed>Ramos pernah membela Los Blancos—julukan Real Madrid-- 16 tahun sejak 2005 lalu. Namun, pada musim panas 2021, dia dilepas oleh klubnya itu dan bergabung dengan PSG.</span></p>\r\n<p><span xss=removed>Bersama Madrid, pemain asal Spanyol itu telah tampil sebanyak 671 kali dan mengangkat 22 trofi. Bahkan, dia menjuarai Liga Champions empat kali yang mana tiga di antaranya diraih secara berturut-turut pada 2016 hingga 2018.</span></p>\r\n<p><span xss=removed>Akan tetapi, semua kenangan manis itu sepertinya akan disingkirkannya untuk sementara pada babak 16 besar kompetisi tertinggi antar klub Eropa itu. Pasalnya, Ramos kini rela mati untuk PSG karena dia akan memberikan segalanya untuk membawa timnya melaju ke babak selanjutnya. Baca juga: Hasil Drawing 16 Besar Liga Champions 2021-2022 Setelah Diulang: PSG vs Real Madrid, Liverpool Jumpa Inter Milan “Anda tahu kasih sayang dan cinta yang saya miliki untuk Real Madrid. Sekarang giliran saya untuk membela PSG dan saya akan melakukan segala kemungkinan untuk lolos,” kata Ramos dilansir dari Mirror, Selasa (14/12/2021). \"Mereka (PSG) adalah tim yang bertaruh pada saya. Saya akan mati demi PSG,” imbuhnya.</span></p>', 'sergio.jpg', 2, 'publish', 'berita', 'Paris Saint-Germain\'s Sergio Ramos wishes club had avoided UCL draw with Real Madrid', NULL, NULL, '2021-12-14 04:20:11', '2021-12-17 08:15:34');
...
(8, 1, 'Rilis Film Spongeboob Series', '<p>Spongeboob Film Terlaris sepanjang masa kini telah merilis Film terbarunya</p>', '', 0, 'spongebob-1.jpg', 'galeri', '2021-12-17 11:11:00', '2021-12-17 04:11:00');
...
(4, 'Dwi', 'rchemical7@gmail.com', 'ngtienotejijwijeq', 'qwoiehjioqjiowejiqjegnrw', '2021-12-18 11:52:54');
...
(1, 'Eden Hazard', 'rchemical7@gmail.com', 'Lizard', '$2y$10$0Tiioj4qMn0tYCmgSYiePugKWAbfnCZ62YxMd7OLKAzKWhq9dAmD.', 'Admin', '2021-12-14 03:46:07'),
(6, 'Kopit\'a Manzukic', '98dwiyulianto@gmail.com', 'MieInstant', '$2y$10$GIu0/DhIxG9fpIsk4QzfF.OpkhjnJt9QfD3WKeKcNrEru.dFfhNkG', 'User', '2021-12-13 13:18:58');
...
--
ALTER TABLE `kategori_berita`
  MODIFY `id_kategori_berita` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `kunjungan`
  MODIFY `id_kunjungan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
